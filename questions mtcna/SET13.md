...
11. Can you manually add drivers to RouterOS in case your PCI Ethernet card is not recognized, and itโ€s a driver issue?
...
19. Router A and B are both running as PPPoE servers on different broadcast domains of your network. Is it possible to set Router A to use โ€/ppp secretโ€ accounts from Router B to authenticate PPPoE customers ?
